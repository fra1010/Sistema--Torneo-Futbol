...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            sys.agregarJugador("Ricado","Bochini","10896458",
                    LocalDate.of(1954, 1, 25), 1.68, 67, "Delantero", 10); // id:1
            
            sys.agregarJugador("Romelu","Lukaku","36896458",
                    LocalDate.of(1993, 5, 13), 1.91, 93, "Delantero", 9);   // id:2
            
            sys.agregarJugador("Martin","Palermo","30896458",
                    LocalDate.of(1973, 10, 7), 1.91, 93, "Delantero", 9);   // id:3
            
            sys.agregarJugador("Franck","Ribéry","10896468",

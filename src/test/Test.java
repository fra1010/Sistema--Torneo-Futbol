...
public class Test {
	...
	public static void main(String[] args) {
		...
		try {
			...
			sys.agregarJugador("Ricado","Bochini","10896458",LocalDate.of(1954, 1, 25),1.68, 67, "Delantero", 10 );
			...
			sys.agregarJugador("Ricado","Palma","10896468",LocalDate.now(),1.68, 67, "Delantero", 10 );
